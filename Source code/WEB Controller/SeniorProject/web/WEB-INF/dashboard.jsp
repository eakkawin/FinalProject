        ...
        <div class="page-wrapper">
            ...
            <div class="page-wrapper-row full-height">
                <div class="page-wrapper-middle">
                    <div class="container">
                    <div class="page-content block-white-home">
                        <div class="col-md-12">
                            <span class="title-text">Automate Classroom Systems</span>
                            <hr>
                        <div class="col-md-8">
                            <img src="assets/pic/user.png" width="100px" height="100px"><span class="welcome-text">Welcome, ${user.username}</span>
                        </div>
                        <div class="col-md-4">
                            <a href="Manage"><button class="button-device border-box">Getting Start</button></a>
                            <button class="button-device border-box">User Guide</button>
                        </div>
                        </div>
                    </div>
                    </div>
