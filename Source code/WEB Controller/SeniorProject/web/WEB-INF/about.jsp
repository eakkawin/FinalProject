                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>About
                                            <small>All about our project</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            ...
                            <div class="container block-white-about about">
                                
                                    <div class="col-lg-12" style="float: left">
                                        <div class="col-lg-5">
                                            <h4>Automate Classroom</h4>
                                            <hr>
                                        <h4>This project is aimed to help infrastructure stuffs</h4>
                                        <h4>and lecturers control classrooms. With this </h4>
                                        <h4>web application, users can manage classroom </h4>
                                        <h4>easier, faster and much more efficient.</h4>
                                        
                                        </div>
                                        <div class="col-lg-4" style="border-left: 1px solid;border-color: #ddd;font-size: 20px;padding-left: 30px; height: 200px;">
                                            <h4>Developed by</h4>
                                            <hr>
                                            <h4>Thapakorn Pimklum</h4>
                                            <h4>Sirasit Mahavanichwong </h4>
                                            <h4>Eakkawin Itthirotjanakul</h4>
                                            
                                        </div>
                                        <div class="col-lg-3" style="border-left: 1px solid;border-color: #ddd;font-size: 20px;padding-left: 30px; height: 200px;">   
                                            <h4>Advise by</h4>
                                            <hr>
                                            <h4>Aj. Montri Supattatham</h4>
                                        </div>
                                    </div>
