                ...
                <div class="page-wrapper-middle">
                    ...
                    <div class="page-container">
                        ...
                        <div class="page-content-wrapper">
                            ...
                            <div class="page-head">
                                <div class="container">
                                    ...
                                    <div class="page-title">
                                        <h1>${device.deviceName}
                                            <small>All device logs</small>
                                        </h1>
                                    </div>
                                    <!-- END PAGE TITLE -->
                                </div>
                            ...
                            <div class="container">
                                <div class="page-content block-white-log log">
                                    <h3>Device Logs</h3>
                                    <hr>
                                    <div class="container">
                                         <div class="portlet-body">
                                             <div class="col-lg-11">
                                                 <div class="col-lg-12 row-border">
                                                     <div class="col-lg-1 table-line">No</div>
                                                     <div class="col-lg-3 table-line">Date</div>
                                                     <div class="col-lg-8 table-line">Events</div>
                                                 </div>
                                                 <div class="scroll-block">
                                                    <c:forEach items="${transactions}" var="tr" varStatus="vs">
                                                    <div class="col-lg-12 row-border">
                                                        <div class="col-lg-1 table-line">${vs.count}</div>
                                                        <div class="col-lg-3 table-line">${tr.dateTime}</div>
                                                        <div class="col-lg-8 table-line">${tr.desc}</div>
                                                    </div>
                                                    </c:forEach>
                                                 </div>
                                             </div>
